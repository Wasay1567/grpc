...
const file_proto_inventory_proto_rawDesc = "" +
	...
	"\n" +
	"CheckStore\x12\x17.inventory.StockRequest\x1a\x18.inventory.StockResponse\x12B\n" +
	"\rDecreaseStock\x12\x17.inventory.StockRequest\x1a\x18.inventory.StockResponseB\x11Z\x0fproto/inventoryb\x06proto3"
...
var file_proto_inventory_proto_depIdxs = []int32{
	0, // 0: inventory.InventoryService.CheckStore:input_type -> inventory.StockRequest
	0, // 1: inventory.InventoryService.DecreaseStock:input_type -> inventory.StockRequest
	1, // 2: inventory.InventoryService.CheckStore:output_type -> inventory.StockResponse
	1, // 3: inventory.InventoryService.DecreaseStock:output_type -> inventory.StockResponse
